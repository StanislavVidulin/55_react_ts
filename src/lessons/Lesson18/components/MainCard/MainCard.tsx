...
function MainCard() {
  ...
  return (
    // Шаг 2. Создаём обёртку, которая позволит получить значение из контекста
    // в любом компоненте, который будет вложен в компонент с обёрткой (внук, правнук и т. д.)
