...
function Lesson11() {
    // state для хранения значения count
...
// Mounting - пример использования useEffect, для выполнения действия при
...
// Update - пример использования useEffect, для выполнения действия при
...
useEffect(() => {
  ...
  return (
    <Lesson11Container>
        <Result>{count}</Result>
      {/* setCount(count + 1) - на один увеличиваем при клике на кнопку */}
