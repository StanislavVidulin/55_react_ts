...
// в блоке catch обрабатывается ошибка (при получении ошибки запроса, информация
// о ней будет передана в error)
  catch (error:any) {
    console.log(error.message);
    // обработка ошибки
    setError(error.message);
} 
// в блоке finally прописывается действия, которые должны быть выполнены в любом случае
